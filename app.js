...
const squirtle = pokeStarter.find(p => p.name === "Squirtle")
...
game.party.push(abra)

const mr_Mime = pokemon.find(p => p.name === "Mr. Mime")
game.party.push(mr_Mime)

const mew = pokemon.find(p => p.name === "Mew")
game.party.push(mew)
